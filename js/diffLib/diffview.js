        ...
        return (function diffview__report() {
            ...
            if (options.diffcli === false) {
                if (options.diffview === "inline") {
                    ...
                    data[0].push("<div class='diff-left col-lg-6'><h3 class='texttitle'>");
                    data[0].push(options.sourcelabel);
                    data[0].push("</h3><ol class='count'>");
                    data[2].push("<div class='diff-right col-lg-6'><h3 class='texttitle'>");
            ...
            if (options.diffview === "inline") {
                ...
                node.push("\"data col-lg-12 versionPopUpContainer\" data-prettydiff-ignore=\"true\">");
                node.push(data[1].join(""));
                node.push("</ol></div>");
            }
            node.push(data[2].join(""));
            node.push("</ol><ol class=\"data col-lg-12 versionPopUpContainer\" data-prettydiff-ignore=\"true\">");

  ...
  .directive('stPagination', ['stConfig', function (stConfig) {
    return {
      ...
      link: function (scope, element, attrs, ctrl) {
        ...
        function redraw () {
          console.log('redraw()->Inside redraw function');
        ...
        //table state --> view
        scope.$watch(function () {
          console.log('before return of tableState().pagination');
          return ctrl.tableState().pagination;
        }, redraw, true);

        //scope --> table state  (--> view)
        scope.$watch('stItemsByPage', function (newValue, oldValue) {
          console.log('before stItemsByPage watch')
          if (newValue !== oldValue) {
            scope.selectPage(1);
          }
        });
        ...
        console.log('before selectpage function')
        //view -> table state
